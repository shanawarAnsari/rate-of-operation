...
const AppRoutes: React.FC = () => {
  return (
    <Routes>
      ...
      />
      <Route
        path="/operations/rate-of-operation"
        element={
          <AuthGuard>
            <RateOfOperation />
          </AuthGuard>
      ...
      />
      <Route
        path="/operations/financial-rate"
        element={
          <AuthGuard>
            <FinancialRate />
          </AuthGuard>
      ...
      />
      <Route
        path="/super-user/user-management"
        element={
          <AuthGuard>
            <UserManagement />
          </AuthGuard>
      ...
      />
      <Route
        path="/super-user/exclusion-list"
        element={
          <AuthGuard>
            <ExclusionList />
          </AuthGuard>
